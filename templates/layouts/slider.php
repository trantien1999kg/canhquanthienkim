                    ...
                    <div data-u="slides"
                        ...
                        <div data-idle="3000">
                            ...
                            <div class="boxslider_details pb10">
                                ...
                                <div class="boxslider_details__title mb30 mt5" data-period="1000"
                                    data-type='[ "<?=$v["ten"]?>" ]'>

                                    <span class="boxslider_details__des-content typewrite_wrap"><?= $v["ten"] ?></span>

                                </div>

                                <div class="box_slider_detail_desc mb35 line-3">
                                    <?= $v["mota"] ?>
                                </div>

                                <div class="box_view_link">
                                    <a href="<?=$v['link']?>" class="link_slider" rel="nofollow"
                                        target="_blank">XEM
                                        THÊM</a>
                                </div>
